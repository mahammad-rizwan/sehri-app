...
const s = StyleSheet.create({
  ...
  backBtnText: { color: '#C9A84C', fontSize: 15, fontWeight: '500' },
  moonGlow: { position: 'absolute', width: 90, height: 90, borderRadius: 45, backgroundColor: 'rgba(201,168,76,0.12)', top: 36 },
  headerTitle: { color: '#F0E6C8', fontSize: 22, fontWeight: '700', marginTop: 8 },
  stepIndicators: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 20, zIndex: 1 },
  stepDot: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#1A2E45', borderWidth: 2, borderColor: '#2A3F55', alignItems: 'center', justifyContent: 'center' },
  stepDotActive: { borderColor: '#C9A84C', backgroundColor: 'rgba(201,168,76,0.2)' },
  stepDotText: { color: '#C9A84C', fontSize: 11, fontWeight: '700' },
  stepLine: { width: 40, height: 2, backgroundColor: '#2A3F55', marginHorizontal: 4 },
  stepLineActive: { backgroundColor: '#C9A84C' },
  card: { padding: 20 },
  stepTitle: { color: '#F0E6C8', fontSize: 22, fontWeight: '700', marginBottom: 4 },
  stepSubtitle: { color: '#A8B8C8', fontSize: 13, marginBottom: 16 },
  label: { color: '#A8B8C8', fontSize: 13, marginBottom: 6, marginTop: 14, fontWeight: '500' },
  hint: { color: '#6B7C8A', fontSize: 11, marginBottom: 6, marginTop: -8 },
  backLink: { color: '#C9A84C', fontSize: 13, marginBottom: 12 },
  timerText: { color: '#6B7C8A', fontSize: 13, marginVertical: 8 },
  fieldError: { color: '#EF5350', fontSize: 11, marginTop: 4 },
  // Fixed field
  fixedField: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#152336', borderRadius: 12, borderWidth: 1.5, borderColor: 'rgba(201,168,76,0.25)', padding: 12, marginBottom: 4 },
  fixedText: { color: '#C9A84C', fontSize: 15, fontWeight: '600' },
  fixedNote: { color: '#6B7C8A', fontSize: 11 },
  // Dropdown
  dropBtn: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#152336', borderRadius: 12, borderWidth: 1.5, borderColor: '#2A3F55', paddingHorizontal: 14, paddingVertical: 13, marginBottom: 4 },
  dropVal: { color: '#F0E6C8', fontSize: 15 },
  dropPlaceholder: { color: '#6B7C8A', fontSize: 15 },
  dropMenu: { backgroundColor: '#0D1B2A', borderRadius: 12, borderWidth: 1, borderColor: '#2A3F55', overflow: 'hidden', marginBottom: 4 },
  dropItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#1A2E45' },
  dropItemActive: { backgroundColor: 'rgba(201,168,76,0.1)' },
  dropItemText: { color: '#A8B8C8', fontSize: 14 },
  dropItemTextActive: { color: '#C9A84C', fontWeight: '600' },
  // Coming soon
  ...
  comingSoonText: { color: '#FF9800', fontSize: 12, flex: 1 },
  // Zone grid
  zoneGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 4 },
  zoneCard: { width: '47%', borderRadius: 14, borderWidth: 1.5, borderColor: '#2A3F55', overflow: 'hidden' },
  zoneGradient: { padding: 14, alignItems: 'center' },
  zoneEmoji: { fontSize: 28, marginBottom: 6 },
  zoneLabel: { color: '#F0E6C8', fontSize: 12, fontWeight: '600', textAlign: 'center' },
  // Input
  input: { backgroundColor: '#152336', borderRadius: 12, borderWidth: 1.5, borderColor: '#2A3F55', paddingHorizontal: 14, paddingVertical: 13, color: '#F0E6C8', fontSize: 15, marginBottom: 4 },
  phoneRow: { flexDirection: 'row', gap: 8 },
  countryCode: { backgroundColor: '#1F3654', borderRadius: 12, borderWidth: 1.5, borderColor: '#2A3F55', paddingHorizontal: 12, justifyContent: 'center' },
  ccText: { color: '#F0E6C8', fontSize: 13 },
  phoneField: { flex: 1 },
  // Toggle
  toggleGroup: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  toggleBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#152336', borderRadius: 12, borderWidth: 1.5, borderColor: '#2A3F55', paddingHorizontal: 14, paddingVertical: 10 },
  toggleSelected: { borderColor: '#C9A84C', backgroundColor: 'rgba(201,168,76,0.1)' },
  toggleText: { color: '#A8B8C8', fontSize: 13, fontWeight: '500' },
  toggleTextSelected: { color: '#C9A84C' },
  // Password
  pwdRow: { flexDirection: 'row', alignItems: 'center' },
  pwdField: { flex: 1, borderTopRightRadius: 0, borderBottomRightRadius: 0 },
  eyeBtn: { backgroundColor: '#152336', borderWidth: 1.5, borderLeftWidth: 0, borderColor: '#2A3F55', borderTopRightRadius: 12, borderBottomRightRadius: 12, paddingHorizontal: 14, paddingVertical: 13, justifyContent: 'center' },
  // Success
  successNote: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, borderRadius: 12, padding: 14, marginTop: 20, width: '100%', borderWidth: 1, borderColor: 'rgba(201,168,76,0.3)' },
  // Zone contacts
  zoneContactsCard: { backgroundColor: '#0A1929', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(201,168,76,0.2)', padding: 14, gap: 10 },
  zoneContactsTitle: { color: '#C9A84C', fontSize: 13, fontWeight: '700', marginBottom: 4 },
  ...
  zoneContactPhone: { color: '#F0E6C8', fontSize: 15, fontWeight: '800', marginTop: 1 },
  // Edit button
  editBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 16, paddingVertical: 12, borderRadius: 12, borderWidth: 1.5, borderColor: 'rgba(201,168,76,0.35)', backgroundColor: 'rgba(201,168,76,0.06)' },
